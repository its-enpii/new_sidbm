                ...
                <AppCard>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <AppButton v-if="form.sumber_dana_row_id" type="button" variant="ghost" size="compact" icon="search" class="!min-h-0 !gap-0.5 !px-0 !text-[11px] !text-on-surface-variant hover:!bg-transparent [&>svg]:!text-xs" @click="inspectAccount(form.sumber_dana_row_id)">
                        ...
                        <div>
                            ...
                            <AppButton v-if="form.disimpan_ke_row_id" type="button" variant="ghost" size="compact" icon="search" class="!min-h-0 !gap-0.5 !px-0 !text-[11px] !text-on-surface-variant hover:!bg-transparent [&>svg]:!text-xs" @click="inspectAccount(form.disimpan_ke_row_id)">
