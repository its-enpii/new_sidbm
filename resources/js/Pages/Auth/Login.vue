    ...
    <main class="flex min-h-screen overflow-hidden bg-surface font-sans text-on-surface">
        ...
        <section class="flex flex-1 flex-col justify-between overflow-y-auto p-6 sm:p-12 lg:p-16 bg-surface-container-lowest">
            ...
            <div ref="formContainerRef" class="my-auto mx-auto w-full max-w-md space-y-8 will-change-transform">
                ...
                <!-- Divider -->
                <div class="form-anim-item relative py-2">
                    <div class="absolute inset-0 flex items-center" aria-hidden="true">
                        <div class="w-full border-t border-outline-variant"></div>
                    </div>
                    <div class="relative flex justify-center">
                        <span class="bg-surface-container-lowest px-4 text-xs font-semibold uppercase tracking-wider text-on-surface-variant">
                ...
                <!-- Google Login -->
                <a href="/auth/google/redirect?action=login" class="form-anim-item block w-full">
                    <AppButton
                        type="button"
                        variant="secondary"
                        size="large"
                        class="w-full font-bold shadow-xs transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md"
                    >
                        <template #icon>
...
<style scoped>
.login-panel {
    background: linear-gradient(145deg, var(--color-primary) 0%, var(--color-primary-container) 100%);
}
</style>
